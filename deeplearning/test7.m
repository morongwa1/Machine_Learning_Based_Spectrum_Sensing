...
grid on
legend('pf=0.10Energy detection','pf=0.10Actual detection','pf=0.10 Deep learning Testing',4);
title ('Comparison of energy detection, actual detection and  detection probability')
xlabel('SNR/dB');

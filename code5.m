...
A=load('svmtrain.txt');     % training data
...
s=svmtrain(training',group,'Method','SMO','Kernel_Function','linear','showplot',true);       %，，
...
figure(4);
plot(snr1,pd,'o-b',snr1,p1,'-*r',snr1,p3,'-.+m');
grid on
legend('pf=0.10Energy detection','pf=0.10Actual detection','pf=0.10SVM Testing',4);
title ('Comparison of energy detection, actual detection and SVM detection probability')
xlabel('SNR/dB');
